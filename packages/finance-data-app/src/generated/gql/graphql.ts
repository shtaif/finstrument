...
export type PositionDataSubscriptionSubscription = { __typename?: 'Subscription', positions: Array<{ __typename?: 'ObservedPositionsUpdate', type: ObservedPositionsUpdateType, data: { __typename?: 'ObservedPosition', symbol: string, totalQuantity: number, breakEvenPrice?: number | null, marketValue: number, priceData: { __typename?: 'InstrumentMarketData', marketState: HoldingStatsMarketState, regularMarketTime: any, regularMarketPrice: number, currency?: string | null }, unrealizedPnl: { __typename?: 'PnlInfo', amount: number, percent: number } } }> };
...
export type LotDataSubscriptionSubscription = { __typename?: 'Subscription', lots: Array<{ __typename?: 'ObservedLotUpdate', type: ObservedLotUpdateType, data: { __typename?: 'ObservedLot', id: string, originalQuantity: number, remainingQuantity: number, unrealizedPnl: { __typename?: 'PnlInfo', amount: number, percent: number } } }> };
